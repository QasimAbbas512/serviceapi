...
/**
 * PagesCredentialsSearch represents the model behind the search form of `app\models\PagesCredentials`.
 */
class PagesCredentialsSearch extends PagesCredentials
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['AppID', 'AppSecret', 'PageToken', 'Active', 'EnteredOn', 'DeletedOn', 'IsDeleted'], 'safe'],
        ];
    }
